...
gradient.spline <- function(
  ...
  # Note that ncores = 1 has to be present for nleqsvl to work (same inputs needed as hessian.spline)
...
prepare_data <- function(t1, t2, cens1, cens2, ncores = 1) {
